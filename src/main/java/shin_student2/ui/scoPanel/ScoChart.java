...
//
        ...
        if(values!=null) {
        	for(Values a : values) {
        		dataset1.addValue(a.getValue(), a.getA(), a.getB());
        	}
        }
...
//        chart.addSubtitle(copyright);  // 차트 서브 타이틀
	...
	class Values{
		...
		public Values(int value, String a, String b) {
			super();
			this.value = value;
			this.a = a;
			this.b = b;
